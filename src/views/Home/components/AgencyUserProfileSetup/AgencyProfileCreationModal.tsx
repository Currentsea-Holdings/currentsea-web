...
import tooltip from '@/assets/agencyTooltip.svg';

const AgencyProfileCreationModal = () => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="border-none text-black">
        <p>
          Before you get started, you need a profile. Get Started Now!
        </p>
      </Modal.Body>
      <Modal.Footer
        className="border-none"
...
export default AgencyProfileCreationModal;
