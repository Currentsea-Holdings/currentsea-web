...
const BrandProfileCreationModal = () => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="border-none text-custom-blue">
        <p>
          Before you get started, you need a profile. Stand out from other brands with an epic
          profile. Get Started Now!
        </p>
      </Modal.Body>
      <Modal.Footer
        className="border-none"
...
export default BrandProfileCreationModal;
